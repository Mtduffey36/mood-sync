...
router.post('/dashboard', async (req, res) => {
    try {
      ...
      console.log('Received data:', { mood_id, content });
      ...
      const plainEntries = entries.map(entry => {
        ...
        console.log('Plain entry:', JSON.stringify(plainEntry, null, 2));
        return plainEntry;
      });
  
      console.log('All plain entries:', JSON.stringify(plainEntries, null, 2));
